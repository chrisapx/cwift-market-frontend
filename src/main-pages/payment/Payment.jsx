...
const Payment = () => {
  ...
  return (
    ...
    {pstatus ? <div style={{fontSize: 16, color: 'grey', fontWeight: '500', textAlign: 'center'}}>Order Placed successfuly. You can now sit and wait for order processing updates on email or phone. Thank you for shopping with Nalmart, we are blessed to have you!</div> : <div style={{fontSize: 16, color: 'grey', fontWeight: '500', textAlign: 'center'}}>Payment Failed</div>}      
