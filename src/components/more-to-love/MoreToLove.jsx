        ...
        {items?.map((item, index) => (
          <div className="more-card" key={index} onClick={() => navigate('/details/' +item.itemID)}>
            ...
            <div className="more-image">
              {/* <img src={item.coverPhoto} alt={item.name} width={'100%'} /> */}
              {/* <img src='src/assets/Laptop.png' alt={item?.name} width={'100%'} /> */}
              {item.coverPhoto !== null ? <img src={item.coverPhoto.url} alt={item.name} width={'90%'} /> :
              <img src={'/src/assets/cwift-logo.png'} alt={item.name} width={'60%'} />}
            </div>
